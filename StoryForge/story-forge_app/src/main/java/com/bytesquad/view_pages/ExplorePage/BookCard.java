...
public class BookCard {
        public VBox createBookCard(String genre, String title, String description,
        ...
        Button addToLibrary = new Button("Add to Library");

        readNow.setStyle("-fx-background-color: #A855F7; -fx-text-fill: white; -fx-background-radius: 10;");
        addToLibrary.setStyle("-fx-border-color: #D6B4FF; -fx-text-fill: #7C3AED; -fx-background-radius: 10;");

        readNow.setPrefWidth(85);
        addToLibrary.setPrefWidth(85);

        HBox buttons = new HBox(10, readNow, addToLibrary);
